...
public class ItemGarlicBulb extends ItemFood implements IHasModel, IPlantable
{
	public ItemGarlicBulb(String name, int amount, float saturation)
	{
		this(name, amount, saturation, false);
	}
	
	public ItemGarlicBulb(String name, int amount, float saturation, boolean isWolfFood)
	{
	...
	{
		return BlockInit.GARLIC_PLANT.getDefaultState();
	}
			...
			EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		{
			worldIn.setBlockState(pos.up(), BlockInit.GARLIC_PLANT.getDefaultState());
			stack.shrink(1);
