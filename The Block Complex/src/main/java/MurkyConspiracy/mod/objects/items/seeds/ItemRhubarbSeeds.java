...
public class ItemRhubarbSeeds extends ItemSeeds implements IHasModel, IPlantable
{
	public ItemRhubarbSeeds(String name, Block soil)
	{
	...
	{
		return BlockInit.RHUBARB_PLANT.getDefaultState();
	}
			...
			EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		{
			worldIn.setBlockState(pos.up(), BlockInit.RHUBARB_PLANT.getDefaultState());
			stack.shrink(1);
