...
public class ItemCauliflowerSeeds extends ItemSeeds implements IHasModel, IPlantable
{
	public ItemCauliflowerSeeds(String name, Block soil)
	{
	...
	{
		return BlockInit.CAULIFLOWER_PLANT.getDefaultState();
	}
			...
			EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		{
			worldIn.setBlockState(pos.up(), BlockInit.CAULIFLOWER_PLANT.getDefaultState());
			stack.shrink(1);
