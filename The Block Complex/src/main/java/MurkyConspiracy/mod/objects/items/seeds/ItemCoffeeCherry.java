...
public class ItemCoffeeCherry extends ItemFood implements IHasModel, IPlantable
{
	public ItemCoffeeCherry(String name, int amount, float saturation)
	{
		this(name, amount, saturation, false);
	}
	
	public ItemCoffeeCherry(String name, int amount, float saturation, boolean isWolfFood)
	{
