package MurkyConspiracy.mod.objects.blocks.tileentities;

import MurkyConspiracy.mod.objects.blocks.machines.BlockMachineGrindStone;
import MurkyConspiracy.mod.objects.blocks.recipes.GrindStoneRecipes;
...
public class TileEntityGrindStone extends TileEntity implements IInventory ,ITickable 
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.grind_stone";
	}
