...
public class BlockMachineGrindStone extends Block implements IHasModel
{
	...
	public BlockMachineGrindStone(String name) 
	{
		super(Material.ROCK);
        setHardness(3F);
        setResistance(8F);
        ...
        ItemInit.ITEMS.add(Item.getItemFromBlock(this));
